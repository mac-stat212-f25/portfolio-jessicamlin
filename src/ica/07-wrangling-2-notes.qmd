...
**Exercise:** Create the string `C:\Users`. What happens when you don't escape the `\`? If you don’t put in the double it gets an error because it is trying to read s a special reference that needs a hex code.
...
```{r}
# str_view(posts$title, "help")
# str_count(posts$title, "love")
# str_detect(posts$question_only, "cat")
# str_subset(posts$title, "husband")
# str_extract(posts$title, "husband")
# str_replace(posts$title, "dog", "chicken")
# str_remove(posts$title, "hate")
```
