...
```{r}
# all <name> nodes under each <item>
name_nodes <- resp |> xml_find_all("item/name")
# actual text is stored in the "value" attribute
game_names <- name_nodes |> xml_attr("value")
game_names
```
